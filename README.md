# 🚀 Simarjit Singh | Cloud Architect & DevOps Engineer

<div align="center">

![Profile Views](https://img.shields.io/badge/expertise-DevOps%20%7C%20Cloud%20%7C%20Infrastructure-blue?style=for-the-badge)
![Status](https://img.shields.io/badge/available-for%20opportunities-brightgreen?style=for-the-badge)
![Years Experience](https://img.shields.io/badge/experience-Cloud%20%26%20DevOps-informational?style=for-the-badge)

<strong>🌟 Building scalable, secure, and intelligent cloud infrastructure through automation and modern DevOps practices</strong>

**Transforming Infrastructure | Automating Deployments | Scaling Systems**
...
I'm a **Cloud Infrastructure Specialist** and **DevOps Engineer** with a passion for architecting enterprise-grade solutions. My expertise spans across:

> **Mission:** Democratizing Infrastructure Automation | Enabling Teams | Building for Scale

### Core Strengths

- **Infrastructure Automation** — Converting manual processes into intelligent, reliable CI/CD pipelines
- **Cloud-Native Design** — Architecting scalable solutions on Microsoft Azure with Kubernetes & IaC
- **Enterprise Security** — Building HIPAA-compliant, production-grade systems with high availability
- **DevOps Excellence** — End-to-end pipeline orchestration with monitoring and observability
- **Healthcare Technology** — Specialized in secure, compliant medical data management systems

**Current Focus:** Advanced Azure networking • AZ-104 Azure Administrator certification • Cloud-native optimization • Kubernetes at scale
...
- ✅ **4+ production-grade cloud applications** deployed successfully
- ✅ **100+ automated deployments** via CI/CD pipelines
- ✅ **HIPAA-compliant healthcare systems** for secure data management
- ✅ **AZ-900 Azure Fundamentals** certified
- ✅ **Advanced Kubernetes & DevOps expertise** with enterprise-scale implementations
